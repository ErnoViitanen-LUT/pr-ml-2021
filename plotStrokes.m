function plotStrokes(data,sampleIndex,plotDigit)
...
function draw_plots(data,sampleIndex)
    ...
    for j=samplesFrom:samplesTo
        for i=0:9 % plot 10 digits in 3D
            ...
            hold on;
            [pos] = plotrects(sample);
            title("3D " + (i*100 + j),"start-end: " + pos(1) +":"+ pos(2));
            hold off;
        end
        for i=0:9 % plot 10 digits in 2D
            ...
            title("2D " + (i*100 + j),"start-end: " + pos(1) +":"+ pos(2));
            hold off;
        end  
    end
    drawnow;  
...
function plot_digit(data,sampleIndex,plotDigit)
    ...
    for j=1:20 % plot 20 digits in 2D
        ...
        title("2D " + (plotDigit*100 + j + sampleIndex),"start-end: " + pos(1) +":"+ pos(2));
